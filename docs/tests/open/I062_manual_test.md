...
|---:|------|----------|--------|--------|------|
| 1 | `/code-review I062` を実行し、生成された `docs/reviews/I062_code_review_*.md` の最終行を確認する | 最終行に `VERDICT: BLOCKER` / `HIGH` / `OK` のいずれか1行が出力されている | Claude | ✅ OK | `docs/reviews/I062_code_review_20260615_2241.md` の最終行 = `VERDICT: OK`。更新後 `code-reviewer.md` の新契約が機能 |
...
| 3 | `/plan-issue-review I062` を実行し、生成された `docs/reviews/I062_plan_review_*.md` の最終行を確認する | 最終行に `VERDICT: BLOCKER` / `HIGHRISK` / `OK` のいずれか1行が出力されている | Claude | ✅ OK | `docs/reviews/I062_plan_review_20260615_2303.md` の最終行 = `VERDICT: OK`。更新後 `plan-reviewer.md` の新契約が機能 |
