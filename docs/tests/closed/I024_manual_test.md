...
| テストID | 結果 | 実施日 | 備考 |
|---------|------|--------|------|
| MT-01 | Pass | 2026-04-03 | entrypoint ログ確認 OK |
| MT-02 | 省略 | 2026-04-03 | ユーザー判断により省略 |
| MT-03 | Pass | 2026-04-03 | SIGTERM 伝播・graceful shutdown 確認 OK |
| MT-04 | Pass | 2026-04-03 | common-commands.md 記載確認 OK |
